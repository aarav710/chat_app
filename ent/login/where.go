...
func StatusEQ(v Status) predicate.Login {
	return predicate.Login(func(s *sql.Selector) {
...
func StatusNEQ(v Status) predicate.Login {
	return predicate.Login(func(s *sql.Selector) {
...
func StatusIn(vs ...Status) predicate.Login {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StatusNotIn(vs ...Status) predicate.Login {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
